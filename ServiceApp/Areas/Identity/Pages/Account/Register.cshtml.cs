...
namespace ServiceApp.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(!await _roleManager.RoleExistsAsync(Constants.Admin))
                    {
                        ...
                        await _roleManager.CreateAsync(new IdentityRole(Constants.Writer));
                        await _roleManager.CreateAsync(new IdentityRole(Constants.Contractor));
                    ...
                    { 
                        if(role == Constants.Contractor)
                        {   var contractor = new Contractor(); 
                            await _userManager.AddToRoleAsync(user, Constants.Contractor);
                        ...
                        if (role == Constants.Writer)
                        {
                            await _userManager.AddToRoleAsync(user, Constants.Writer);
                        } 
                    }
