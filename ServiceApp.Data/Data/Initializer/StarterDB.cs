...
namespace ServiceApp.Data.Data.Initializer
{
    public class StarterDB : IStarterDB
    {
        ...
        public void Start()
        {
            ...
            ApplicationUser user = _context.ApplicationUser.Where(us => us.Email == "admin@admin.com").FirstOrDefault();
            _userManager.AddToRoleAsync(user, Utilities.Constants.Admin).GetAwaiter().GetResult();
        }
    }
}
